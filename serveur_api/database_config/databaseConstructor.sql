CREATE TABLE colors(color_id serial PRIMARY KEY,
                                            name text);
...
CREATE TABLE conditions(condition_id serial PRIMARY KEY,
                                                    name text not null);


CREATE TABLE materials(material_id serial PRIMARY KEY,
                                                  name text not null);
                                                                                                    ...
                                                                                                    surname text not null,
                                                                                                                 email text not null,
                                                                                                                            password text not null,
                                                                                                                                          phone smallint, address text);

-- ==== NEED TO WORK ON THIS ==== --

CREATE TABLE furnitures(furniture_id serial PRIMARY KEY,
...
CREATE TABLE furniture_user(id serial PRIMARY KEY,
