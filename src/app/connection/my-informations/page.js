...
//           <p className="text-xl font-bold">Mes informations</p>
//           <div className="flex flex-col items-start justify-center ">
//             <p className="text-xl font-bold">Nom:</p>
//             <p className="text-xl font-bold">Prénom:</p>
//             <p className="text-xl font-bold">Adresse mail:</p>
//             <p className="text-xl font-bold">Adresse postale:</p>
//             <p className="text-xl font-bold">Téléphone:</p>
//             {/* <div className="my-6" /> */}
